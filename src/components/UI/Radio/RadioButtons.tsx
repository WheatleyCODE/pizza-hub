...
const RadioButtons: React.FC<IRadioButtonsProps> = ({ buttons, selected, onChange }) => {
      ...
      {buttons.map(({ title, style, value }, index) => {
        ...
        if (style === 'disable') {
          return (
            <div
              aria-hidden="true"
              key={title}
              className={`RadioButtons__group ${selectedClassName} ${style}`}
            >
              <input
              ...
              />
              <label className="RadioButtons__group__label" htmlFor={inputID}>
                {title}
              </label>
            </div>
          );
        ...
        return (
          <div
            ...
            key={title}
            className={`RadioButtons__group ${selectedClassName}`}
          >
            <input
              className="RadioButtons__group__input"
              type="radio"
